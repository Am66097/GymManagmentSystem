        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserVaildPhoneCheck", "PhoneNumber Like '01%' and PhoneNumber Not like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("SessionVaildDayCheck", "Capacity between 1 and 25");
                    table.CheckConstraint("SessionVaildEndTimeCheck", "EndDate > StartDate");
                    table.ForeignKey(
